...
<body>
	...
	Add New Product
		<a class="btn btn-success a-margin" href="<c:url value="addNewProduct"/>">Add Product<span
			class="icon-plus"></span></a> 
	</div>
	<hr>
	<div class="row">
		<h3>
			<span style="margin-left: 25px;"> All Products Management<span
				style="font-size: smaller;"> (${all_products.size()})</span>
			</span>
		</h3>
						...
						<li class="span4">
							<div class="thumbnail">
								...
								<div class="caption">
									...
									<h4>
										<a class="defaultBtn"
											href="<c:url value="/EditProduct/${item.id_product}"/>"
											title="Edit"><span class="icon-pencil"></span></a> <a
											class="shopBtn"
											href="<c:url value="DeleteProduct/${item.id_product}"/>"
											title="Delete"><span class="icon-minus"></span></a> <span
